 ...
 */
public class MultiStreamRewritingEngine
    ...
    implements TransformEngine
{
    ...
    /**
     * The <tt>Logger</tt> used by the <tt>MultiStreamRewritingEngine</tt> class
     * and its instances to print debug information.
     */
    private static final Logger logger
        = Logger.getLogger(MultiStreamRewritingEngine.class);
     ...
     */
    public MultiStreamRewritingEngine(MediaStream stream)
    {
    ...
    public RawPacket transform(RawPacket pkt)
    {
        ...
        if (rewriter == null)
        {
            ...
            if (receiveRTPManager != null)
            {
                ...
                {
                    MediaStreamTrackResolver resolver =
                        MediaStreamExtensions.getMediaStreamTrackResolver(receiveStream);

                    if (resolver != null)
                    {
                        track = resolver.resolveMediaStreamTrack(pkt);
                    }
                }
            }
            ...
            if (track == null)
            {
                ...
                {
                    logger.error("err_track_not_found"
            ...
            long trackSSRC = track.getRTPEncodings()[0].getPrimarySSRC();
